...
public class Motocicleta extends Vehiculo{
    ...
    public String toString() {
        return "Motocicleta{ ID=" + this.ID +", IDvehiculo= " + super.IDvehiculo + ", IDvendedor=" + + super.IDvendedor +  ", placa=" + super.placa + ", marca=" + super.marca + ", modelo=" + super.modelo + ", tipo_motor=" + super.tipo_motor + ", anio=" + super.año + ", recorrido=" + super.recorrido + 
